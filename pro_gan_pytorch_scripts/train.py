...
from pro_gan_pytorch.networks import Discriminator, Generator, EncoderDecoder
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--num_feedback_samples", action="store", type=int, required=False, default=20,
    ...
    parsed_args.epochs = parsed_args.epochs[:parsed_args.depth-1]
    parsed_args.batch_sizes = parsed_args.batch_sizes[:parsed_args.depth-1]
    return parsed_args
...
def train_progan(args: argparse.Namespace) -> None:
    ...
    data_loader = ImageDirectoryDataset(
            args.train_path,
    ...
    generator = EncoderDecoder(
        ...
        num_classes = len(data_loader.class2idx)
    )
